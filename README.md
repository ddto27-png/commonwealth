...
The [proofreading desk](pipeline/proof.html) places exact copy beside sources, link status and review blockers. See [editorial rules](pipeline/EDITORIAL.md) and the [audience and direction brief](research/audience-and-direction.md). Browser review notes stay local until exported and given to Codex. Source checks and approval gates are implemented; the full existing collection has not yet been certified accurate.
